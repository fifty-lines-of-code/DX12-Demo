...
namespace Engine {
	...
	const Matrix4x4& Camera::GetViewProjection() const {
		return mViewProjection;
	}

	const BasisVectors& Camera::GetBasisVectors() const {
		return mBasisVectors;
	}

	const Vector3& Camera::GetPosition() const noexcept { return mCenter; }
